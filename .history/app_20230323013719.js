...
volumeS.setAttribute("type", "range");

// Attribution de l'ID "volumeSlider"
volumeS.setAttribute("id", "volumeSlider");

// Définition des attributs "min", "max", "value" et "step"
volumeslice.setAttribute("min", "0");
volumeS.setAttribute("max", "100");
volumeS.setAttribute("value", "50");
volumeS.setAttribute("step", "1");
buttons.appendChild(volumeS);
